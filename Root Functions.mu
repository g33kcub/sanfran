...
@@
@parent #31=#29
&startup`functions #31=staffbit isstaff safepassword caps cnum numth gtm ispowered su hasrole roles line gameconfig myvalid wgrepi alert newfile itemize gamename sdesc hideidle statustag mplayers mthings mexits global hname xp

&xp #31=0

&hname #31=[ansi(010,$)][mid([name(%0)],1,99)]
